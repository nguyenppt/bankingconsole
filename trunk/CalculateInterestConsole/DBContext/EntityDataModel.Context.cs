...
namespace CalculateInterestConsole.DBContext
{
    using System;
    ...
    public partial class VietVictoryCoreBankingEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> B_Normal_Loan_Process_Payment(Nullable<System.DateTime> endDateProcess)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("B_Normal_Loan_Process_Payment", endDateProcessParameter);
        }
    }
}
